...
class ATBSN_D_Model(BaseModel):
    def __init__(self, opt):
        super(ATBSN_D_Model, self).__init__(opt)
        ...
        self.MoBanNet = DoubleNet().to(self.device) # used for distilling atbsn-d or testing atbsn-d
        ...
        freeze(self.MoBanNet.module.bsn) # used for distilling atbsn-d
    ...
    def optimize_parameters(self, step):
        ...
        self.pred_n_bsn, self.pred_bsn = self.MoBanNet(self.noisy, hole_size=[0,1,3,5,7,9,11], mode="train")
        l_n2n = 0.0
        for i in self.pred_bsn:
            l_n2n = l_n2n + self.loss_forward(self.pred_n_bsn, i.detach())
